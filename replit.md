...
- **Init-query timeout**: `defaultQueryTimeoutMs` raised 60s → 90s. Replit network occasionally pushes Baileys `chats.js fetchProps` past 60s, which previously triggered "Timed Out" + `Connection Terminated` (err 1006) right after a fresh login.
